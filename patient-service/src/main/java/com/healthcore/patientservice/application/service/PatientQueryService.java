...
public class PatientQueryService implements PatientQueryUseCase {
    ...
    /* =========================================================
       ...
       ========================================================= */
    @Override
    public PatientDetails getPatientById(UUID patientId, String tenantId) {

        return queryRepository.findPatientById(patientId, tenantId)
                .orElseThrow(() ->
    ...
    /* =========================================================
       ...
       ========================================================= */
    public PageResult<PatientListItem> getPatients(
            String tenantId,
            int pageNo,
            int size,
            String sortBy,
        ...
        Page<PatientListItem> page =
                queryRepository.findByIdAndTenantId(tenantId, pageable);
