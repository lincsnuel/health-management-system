...
public class PatientEntity extends BaseEntity {
    ...
    public void addAddress(AddressEntity address) {
        ...
        address.assignToPatient(this);
    }

    public void addResponsibleParty(ResponsiblePartyEntity party) {
        this.responsibleParties.add(party);
        party.setPatient(this);
    }

    public void addInsurance(PatientInsuranceEntity insurance) {
        this.insurancePolicies.add(insurance);
        insurance.assignToPatient(this);
    }

    public void addDocument(PatientDocumentEntity document) {
