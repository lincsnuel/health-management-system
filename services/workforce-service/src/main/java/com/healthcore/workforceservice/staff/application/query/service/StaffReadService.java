package com.healthcore.workforceservice.staff.application.query.service;
...
import com.healthcore.workforceservice.staff.application.query.usecase.StaffReadUseCase;
...
public class StaffReadService implements StaffReadUseCase {
    ...
    public PageResult<StaffView> getAllStaff(String tenantId,
        ...
        Page<StaffView> page =
                staffRepository.findByTenantId(pageable);
